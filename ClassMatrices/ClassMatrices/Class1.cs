...
namespace ClassMatrices
{
    public class DosPorDos
    {
        /**
         *
         * Primero, todos los numero de la fila
         * se dividen por el primer numero de la
         * fila (a1).
         *
         * a1 b1 = a <--- cada uno / a1
         * a2 b2 = b
        ...
        /**
         *
         * Segundo, cada numero de la primera fila
         * es multiplicado por el resultado del primer
         * numero de la segunda fila por -1 y despues
         * se suma cada numero de la segunda fila.
         *
         * a1 b1 = a
         * a2 b2 = b <--- cada uno (primera fila) * (a2 * -1) + cada uno (segunda fila)
         */
